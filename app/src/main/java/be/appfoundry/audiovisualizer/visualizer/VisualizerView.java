package be.appfoundry.audiovisualizer.visualizer;
...
import be.appfoundry.audiovisualizer.visualizer.shape.ShapeDrawer;
...
public class VisualizerView extends View {
    ...
    private void init() {
        ...
        mFadePaint.setColor(Color.argb(238, 255, 255, 255)); // Change Alpha to adjust fading speed
